                    ...
                    {books.map((book, index) => (
                        <div key={index} className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl flex flex-col items-center h-full border border-slate-700">
                            ...
                            <div className="mt-5 flex items-center justify-center gap-2 flex-wrap">
                                <a className="inline-flex items-center gap-2 bg-amber-400 text-black font-bold py-2.5 px-6 rounded-full shadow-lg transition-transform hover:scale-105 hover:bg-amber-300"
