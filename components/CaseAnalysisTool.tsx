...
`;
            ...
            let friendlyErrorMessage = 'An unexpected error occurred while analyzing your document. Please click "Retry" or try again later.';

            if (err instanceof Error) {
                const message = err.message.toLowerCase();
                
                if (message.includes('api key')) {
                    friendlyErrorMessage = 'The analysis service is currently unavailable due to a configuration issue. Please try again later or contact support.';
                } else if (message.includes('fetch') || err.name === 'TypeError') {
                    friendlyErrorMessage = 'A network error occurred. Please check your internet connection and click "Retry".';
                } else if (message.includes('safety') || message.includes('blocked')) {
                    friendlyErrorMessage = 'Your document could not be analyzed due to content safety restrictions. Please review the document for sensitive personal information or inappropriate material and try again.';
                }
            }
